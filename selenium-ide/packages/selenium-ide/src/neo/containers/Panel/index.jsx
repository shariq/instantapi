...
import PublishAPI from '../../components/ActionButtons/PublishAPI'
...
async function exportCode(project) {
  UiState.selectPro
  console.log('project', project, project.suites[0]);
  return await exportCodeToFile(['javascript-mocha'],{
    test: null,
    suite: project.suites[0].export(),
  },{enableOriginTracing: false, beforeEachOptions:false });
}
